    ...
    public void validateSpellerAnswerAsAnObject() {
        List<YandexSpellerAnswer> answers =
                YandexSpellerApi.getYandexSpellerAnswers(
                        YandexSpellerApi.with().text("motherr fatherr," + WRONG_WORD_EN).callGetApi());
        ...
        assertThat(answers.get(0).getSimilar().get(0), equalTo("mother"));
        assertThat(answers.get(1).getSimilar().get(0), equalTo("father"));
        assertThat(answers.get(2).getSimilar().get(0), equalTo(RIGHT_WORD_EN));
    }
        ...
        List<YandexSpellerAnswer> answers =
                YandexSpellerApi.getYandexSpellerAnswers(
                        YandexSpellerApi.with().
                                ...
                                .options(Option.IGNORE_CAPITALIZATION)
                                .callGetApi());
        assertThat("expected number of answers is wrong.", answers.size(), equalTo(0));
    }
